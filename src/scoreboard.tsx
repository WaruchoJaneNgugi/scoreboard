...
async function saveState(state: typeof DEFAULT_STATE) {
  try {
...
export function ScoreCard({ team, color, side }) {
...
// ─── Viewer View ─────────────────────────────────────────────────────
export function ViewerView({ onBack }) {
...
// ─── Admin View ──────────────────────────────────────────────────────
export function ScoreInput({ label, value, color, onChange }) {
  return (
      <div style={{ width: "100%" }}>
        <label style={{
          fontSize: 12,
...
export function TeamNameInput({ label, value, color, onChange }) {
  return (
      <div style={{ width: "100%" }}>
        <label style={{
          fontSize: 12,
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                <TeamNameInput
                    ...
                    color="var(--primary)"
                    onChange={v => updateState(s => ({ ...s, teamA: { ...s.teamA, name: v } }))}
                />
                <ScoreInput
                    label="Score"
                    value={state.teamA.score}
                    color="var(--primary)"
                    onChange={v => updateState(s => ({ ...s, teamA: { ...s.teamA, score: v } }))}
                />
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                <TeamNameInput
                    ...
                    color="var(--secondary)"
                    onChange={v => updateState(s => ({ ...s, teamB: { ...s.teamB, name: v } }))}
                />
                <ScoreInput
                    label="Score"
                    value={state.teamB.score}
                    color="var(--secondary)"
                    onChange={v => updateState(s => ({ ...s, teamB: { ...s.teamB, score: v } }))}
                />
              </div>
            </div>
